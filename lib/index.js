...
import { publicKeyPemFromCertificatePem } from './forge.js';
...
internals.validateSignature = async (payload, certCache) => {
    ...
    const publicKeyPem = publicKeyPemFromCertificatePem(certificatePem);
...
const Validator = class {
    constructor({ useCache = true, maxCerts = 1000, autoSubscribe = true, autoResubscribe = true } = {}) {
